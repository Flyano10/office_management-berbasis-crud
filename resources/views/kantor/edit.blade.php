...
@section('page-subtitle', 'Perbarui informasi kantor: ' . $kantor->nama_kantor)
                        ...
                        <form action="{{ route('kantor.update', $kantor->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control modern-input" id="luas_tanah" name="luas_tanah" value="{{ old('luas_tanah', $kantor->luas_tanah) }}" placeholder="Contoh: 1500">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="luas_bangunan" class="form-label">Luas Bangunan (m<sup>2</sup>)</label>
                                        <input type="number" step="0.01" min="0" class="form-control modern-input" id="luas_bangunan" name="luas_bangunan" value="{{ old('luas_bangunan', $kantor->luas_bangunan) }}" placeholder="Contoh: 1200">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="0" class="form-control modern-input" id="daya_listrik_va" name="daya_listrik_va" value="{{ old('daya_listrik_va', $kantor->daya_listrik_va) }}" placeholder="Contoh: 66000">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="kapasitas_genset_kva" class="form-label">Kapasitas Genset (kVA)</label>
                                        <input type="number" min="0" class="form-control modern-input" id="kapasitas_genset_kva" name="kapasitas_genset_kva" value="{{ old('kapasitas_genset_kva', $kantor->kapasitas_genset_kva) }}" placeholder="Contoh: 80">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="0" class="form-control modern-input" id="jumlah_sumur" name="jumlah_sumur" value="{{ old('jumlah_sumur', $kantor->jumlah_sumur) }}" placeholder="Contoh: 2">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="jumlah_septictank" class="form-label">Jumlah Septic Tank/Biofil</label>
                                        <input type="number" min="0" class="form-control modern-input" id="jumlah_septictank" name="jumlah_septictank" value="{{ old('jumlah_septictank', $kantor->jumlah_septictank) }}" placeholder="Contoh: 3">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modern-select @error('jenis_kantor_id') is-invalid @enderror" id="jenis_kantor_id" name="jenis_kantor_id" required>
                                            ...
                                            @foreach($jenisKantor as $jk)
                                                <option value="{{ $jk->id }}" {{ old('jenis_kantor_id', $kantor->jenis_kantor_id) == $jk->id ? 'selected' : '' }}>
                                                    {{ $jk->nama_jenis }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modern-select @error('kota_id') is-invalid @enderror" id="kota_id" name="kota_id" required>
                                            ...
                                            @foreach($kota as $k)
                                                <option value="{{ $k->id }}" {{ old('kota_id', $kantor->kota_id) == $k->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control modern-input @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3" 
                                          placeholder="Masukkan alamat lengkap kantor" required>{{ old('alamat', $kantor->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modern-select @error('status_kantor') is-invalid @enderror" id="status_kantor" name="status_kantor" required>
                                            <option value="aktif" {{ old('status_kantor', $kantor->status_kantor) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                            <option value="tidak_aktif" {{ old('status_kantor', $kantor->status_kantor) == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                        </select>
                                        @error('status_kantor')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modern-select" id="status_kepemilikan" name="status_kepemilikan" required>
                                            <option value="milik" {{ old('status_kepemilikan', $kantor->status_kepemilikan) == 'milik' ? 'selected' : '' }}>Milik</option>
                                            <option value="sewa" {{ old('status_kepemilikan', $kantor->status_kepemilikan) == 'sewa' ? 'selected' : '' }}>Sewa</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modern-select" id="jenis_kepemilikan" name="jenis_kepemilikan" required>
                                            <option value="tunai" {{ old('jenis_kepemilikan', $kantor->jenis_kepemilikan) == 'tunai' ? 'selected' : '' }}>Tunai</option>
                                            <option value="non_tunai" {{ old('jenis_kepemilikan', $kantor->jenis_kepemilikan) == 'non_tunai' ? 'selected' : '' }}>Non Tunai</option>
                                            <option value="non_pln" {{ old('jenis_kepemilikan', $kantor->jenis_kepemilikan) == 'non_pln' ? 'selected' : '' }}>Non PLN</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="guide-card">
                    ...
                    <div class="guide-body">
                        ...
                        <div class="guide-section">
                            <h6 class="guide-section-title">Informasi Sistem</h6>
                            <ul class="guide-list">
                                <li><i class="fas fa-check-circle"></i> ID: {{ $kantor->id }}</li>
                                <li><i class="fas fa-check-circle"></i> Dibuat: {{ $kantor->created_at->format('d/m/Y H:i') }}</li>
                                <li><i class="fas fa-check-circle"></i> Diupdate: {{ $kantor->updated_at->format('d/m/Y H:i') }}</li>
                                <li><i class="fas fa-check-circle"></i> Status: {{ ucfirst($kantor->status_kantor) }}</li>
                            </ul>
                        </div>
