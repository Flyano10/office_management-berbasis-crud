                                ...
                                <form id="filter-form" method="GET">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="date" class="form-control" name="tanggal_mulai_dari" value="{{ request('tanggal_mulai_dari') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Tanggal Mulai Sampai</label>
                                            <input type="date" class="form-control" name="tanggal_mulai_sampai" value="{{ request('tanggal_mulai_sampai') }}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="d-grid gap-2">
                                                ...
                                                <a href="{{ route('kontrak.index') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="table-responsive" style="overflow-x: auto; max-width: 100%; border: 1px solid #dee2e6; border-radius: 0.375rem; position: relative;">
                    <table class="table table-hover mb-0" style="min-width: 1200px; position: relative;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="form-check-input item-checkbox" value="{{ $k->id }}">
                                </td>
                            ...
                            <tr>
                                <td colspan="9" class="text-center text-muted">
                                    ...
                                    Belum ada data kontrak. Silakan tambah data kontrak baru.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
