...
@section('page-subtitle', 'Ubah data kontrak')
                ...
                <div class="kontrak-form-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('kantor_id') is-invalid @enderror" id="kantor_id" name="kantor_id" required>
                                    ...
                                    @foreach($kantor as $k)
                                        <option value="{{ $k->id }}" {{ old('kantor_id', $kontrak->kantor_id) == $k->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('status_perjanjian') is-invalid @enderror" 
                                    ...
                                    <option value="Baru" {{ old('status_perjanjian', $kontrak->status_perjanjian) == 'Baru' ? 'selected' : '' }}>Baru</option>
                                    <option value="Amandemen" {{ old('status_perjanjian', $kontrak->status_perjanjian) == 'Amandemen' ? 'selected' : '' }}>Amandemen</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="Tidak Aktif" {{ old('status', $kontrak->status) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    <option value="Batal" {{ old('status', $kontrak->status) == 'Batal' ? 'selected' : '' }}>Batal</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <select class="form-select modern-select" id="sbu_type" name="parent_kantor" style="max-width: 120px;">
                                        ...
                                        <option value="Pusat" {{ old('parent_kantor', $kontrak->parent_kantor) == 'Pusat' ? 'selected' : '' }}>Pusat</option>
                                        <option value="SBU" {{ old('parent_kantor', $kontrak->parent_kantor) == 'SBU' ? 'selected' : '' }}>SBU</option>
                                        <option value="Perwakilan" {{ old('parent_kantor', $kontrak->parent_kantor) == 'Perwakilan' ? 'selected' : '' }}>Perwakilan</option>
                                        <option value="Gudang" {{ old('parent_kantor', $kontrak->parent_kantor) == 'Gudang' ? 'selected' : '' }}>Gudang</option>
                                    </select>
                                    <input type="text" class="form-control modern-input" id="sbu" name="parent_kantor_nama" 
                                           placeholder="Contoh: SBU Jakarta" value="{{ old('parent_kantor_nama', $kontrak->parent_kantor_nama) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control modern-input @error('ruang_lingkup') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsikan ruang lingkup perjanjian">{{ old('ruang_lingkup', $kontrak->ruang_lingkup) }}</textarea>
                                    @error('ruang_lingkup')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('peruntukan_kantor') is-invalid @enderror" 
                                    ...
                                    <option value="Kantor SBU" {{ old('peruntukan_kantor', $kontrak->peruntukan_kantor) == 'Kantor SBU' ? 'selected' : '' }}>Kantor SBU</option>
                                    <option value="Kantor KP" {{ old('peruntukan_kantor', $kontrak->peruntukan_kantor) == 'Kantor KP' ? 'selected' : '' }}>Kantor KP</option>
                                    <option value="Gudang" {{ old('peruntukan_kantor', $kontrak->peruntukan_kantor) == 'Gudang' ? 'selected' : '' }}>Gudang</option>
                                </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control modern-input @error('alamat') is-invalid @enderror" 
                                  ...
                                  placeholder="Masukkan alamat lengkap" required>{{ old('alamat', $kontrak->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @if($kontrak->berita_acara)
                                    <small class="text-muted">File saat ini: <a href="{{ asset('uploads/berita_acara/' . $kontrak->berita_acara) }}" target="_blank">{{ $kontrak->berita_acara }}</a></small>
                                @else
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control modern-input @error('keterangan') is-invalid @enderror" 
                                          ...
                                          placeholder="Masukkan keterangan tambahan (opsional)">{{ old('keterangan', $kontrak->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            </div>
