                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status_perjanjian" name="status_perjanjian" required>
                                    ...
                                    <option value="berjalan" {{ old('status_perjanjian') == 'berjalan' ? 'selected' : '' }}>Berjalan</option>
                                    <option value="selesai" {{ old('status_perjanjian') == 'selesai' ? 'selected' : '' }}>Selesai</option>
                                </select>
                            </div>
                        </div>
                    </div>
