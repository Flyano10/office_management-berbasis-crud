...
@section('page-subtitle', 'Edit data gedung: ' . $gedung->nama_gedung)

@section('page-actions')
    <a href="{{ route('gedung.show', $gedung->id) }}" class="btn btn-modern btn-clear">
                ...
                <form action="{{ route('gedung.update', $gedung->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('kantor_id') is-invalid @enderror" 
                                    ...
                                    @foreach($kantor as $k)
                                        <option value="{{ $k->id }}" {{ old('kantor_id', $gedung->kantor_id) == $k->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control modern-input @error('alamat') is-invalid @enderror" 
                                  id="alamat" name="alamat" rows="3" required>{{ old('alamat', $gedung->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('status_gedung') is-invalid @enderror" 
                                    ...
                                    <option value="aktif" {{ old('status_gedung', $gedung->status_gedung) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="non_aktif" {{ old('status_gedung', $gedung->status_gedung) == 'non_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                </select>
                                @error('status_gedung')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-select @error('status_kepemilikan') is-invalid @enderror" 
                                    ...
                                    <option value="milik" {{ old('status_kepemilikan', $gedung->status_kepemilikan) == 'milik' ? 'selected' : '' }}>Milik</option>
                                    <option value="sewa" {{ old('status_kepemilikan', $gedung->status_kepemilikan) == 'sewa' ? 'selected' : '' }}>Sewa</option>
                                </select>
