...
@section('page-subtitle', 'Buat data realisasi kontrak baru')
                                    ...
                                    <div class="row" id="kontrak-data" style="display: none;">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control modern-input" id="no_perjanjian_pihak_1" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">No Perjanjian Pihak 2</label>
                                                <input type="text" class="form-control modern-input" id="no_perjanjian_pihak_2" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Tanggal Mulai</label>
                                                <input type="date" class="form-control modern-input" id="tanggal_mulai" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Tanggal Selesai</label>
                                                <input type="date" class="form-control modern-input" id="tanggal_selesai" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control modern-input @error('rp_kompensasi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('rp_kompensasi') }}" required>
                                    @error('rp_kompensasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
