...
@section('title', 'Edit Sub Bidang - PLN Icon Plus Kantor Management')
@section('page-title', 'Edit Sub Bidang')
@section('page-subtitle', 'Ubah data sub bidang')
                    ...
                    <form action="{{ route('sub-bidang.update', $subBidang->id) }}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control modern-input @error('nama_sub_bidang') is-invalid @enderror" 
                                           ...
                                           value="{{ old('nama_sub_bidang', $subBidang->nama_sub_bidang) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select modern-select @error('bidang_id') is-invalid @enderror" id="bidang_id" name="bidang_id" required>
                                        ...
                                        @foreach($bidang as $b)
                                            <option value="{{ $b->id }}" {{ old('bidang_id', $subBidang->bidang_id) == $b->id ? 'selected' : '' }}>
                                                {{ $b->nama_bidang }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control modern-input @error('deskripsi') is-invalid @enderror" 
                                              ...
                                              placeholder="Masukkan deskripsi sub bidang">{{ old('deskripsi', $subBidang->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-modern btn-primary">
                                <i class="fas fa-save"></i> Update Sub Bidang
                            </button>
                            <a href="{{ route('sub-bidang.index') }}" class="btn btn-modern btn-clear">
