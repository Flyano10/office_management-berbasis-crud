...
@section('title', 'Edit Okupansi - PLN Icon Plus Kantor Management')
@section('page-title', 'Edit Okupansi')
@section('page-subtitle', 'Ubah data okupansi')
        ...
        <div class="col-lg-8">
            <div class="okupansi-form-card">
                ...
                <div class="okupansi-form-body">
                    <form action="{{ route('okupansi.update', $okupansi->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select modern-select @error('ruang_id') is-invalid @enderror" 
                                        ...
                                        @foreach($ruang as $r)
                                            <option value="{{ $r->id }}" {{ old('ruang_id', $okupansi->ruang_id) == $r->id ? 'selected' : '' }}>
                                                {{ $r->nama_ruang }} - Lantai {{ $r->lantai->nomor_lantai ?? 'N/A' }} - {{ $r->lantai->gedung->nama_gedung ?? 'N/A' }} ({{ $r->lantai->gedung->kantor->nama_kantor ?? 'N/A' }})
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('ruang_id')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control modern-input @error('tanggal_okupansi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tanggal_okupansi', $okupansi->tanggal_okupansi) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select modern-select @error('bidang_id') is-invalid @enderror" 
                                        ...
                                        @foreach($bidang as $b)
                                            <option value="{{ $b->id }}" {{ old('bidang_id', $okupansi->bidang_id) == $b->id ? 'selected' : '' }}>
                                                {{ $b->nama_bidang }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select modern-select @error('sub_bidang_id') is-invalid @enderror" 
                                        ...
                                        @foreach($subBidang as $sb)
                                            <option value="{{ $sb->id }}" {{ old('sub_bidang_id', $okupansi->sub_bidang_id) == $sb->id ? 'selected' : '' }}>
                                                {{ $sb->nama_sub_bidang }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control modern-input @error('jml_pegawai_organik') is-invalid @enderror" 
                                           ...
                                           value="{{ old('jml_pegawai_organik', $okupansi->jml_pegawai_organik) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control modern-input @error('jml_pegawai_tad') is-invalid @enderror" 
                                           ...
                                           value="{{ old('jml_pegawai_tad', $okupansi->jml_pegawai_tad) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control modern-input @error('jml_pegawai_kontrak') is-invalid @enderror" 
                                           ...
                                           value="{{ old('jml_pegawai_kontrak', $okupansi->jml_pegawai_kontrak ?? 0) }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control modern-input @error('keterangan') is-invalid @enderror" 
                                              ...
                                              placeholder="Masukkan keterangan tambahan">{{ old('keterangan', $okupansi->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-modern btn-primary">
                                <i class="fas fa-save"></i> Update Okupansi
                            </button>
                            <a href="{{ route('okupansi.index') }}" class="btn btn-modern btn-clear">
