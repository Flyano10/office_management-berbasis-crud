                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_ruang" name="nama_ruang" 
                                       placeholder="Contoh: Ruang Meeting, Ruang Kerja, dll" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="kapasitas" name="kapasitas" 
                                       placeholder="Contoh: 10, 20, 50, dll" min="1" 
                                ...
                                <select class="form-select" id="lantai_id" name="lantai_id" required>
                                    ...
                                    @foreach($lantai as $l)
                                        <option value="{{ $l->id }}" {{ old('lantai_id') == $l->id ? 'selected' : '' }}>
                                            Lantai {{ $l->nomor_lantai }} - {{ $l->gedung->nama_gedung }} ({{ $l->gedung->kantor->nama_kantor }})
                                        </option>
                                    @endforeach
                                </select>
                            </div>
