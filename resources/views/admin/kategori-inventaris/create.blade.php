...
@section('title', 'Tambah Kategori Inventaris - PLN Icon Plus Kantor Management')
@section('page-title', 'Tambah Kategori Inventaris Baru')
@section('page-subtitle', 'Buat data kategori inventaris baru')
            ...
            <div class="kontrak-form-card">
                <div class="kontrak-form-header">
                    <h5 class="kontrak-form-title">
                        ...
                        Form Tambah Kategori Inventaris
                    </h5>
                </div>
                <div class="kontrak-form-body">
                    <form action="{{ route('kategori-inventaris.store') }}" method="POST">
                        @csrf
