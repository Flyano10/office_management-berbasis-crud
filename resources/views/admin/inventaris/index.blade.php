...
@section('title', 'Data Inventaris - PLN Icon Plus Kantor Management')
            ...
            <div class="kontrak-card">
                <div class="kontrak-header">
                    <h5 class="kontrak-title">
                        ...
                        Daftar Inventaris PLN Icon Plus
                        </h5>
                    </div>
                        ...
                        <form method="GET" action="{{ route('inventaris.index') }}">
                                ...
                                <div class="col-md-3">
                                        <label for="kategori_id" class="form-label">Kategori</label>
                                                <select class="form-select modern-select" id="kategori_id" name="kategori_id">
                                ...
                                <div class="col-md-3">
                                        <label for="kondisi" class="form-label">Kondisi</label>
                                                <select class="form-select modern-select" id="kondisi" name="kondisi">
                        ...
                        <div class="table-responsive" id="tableContainer">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge modern-badge badge-primary">{{ $item->kode_inventaris }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge modern-badge badge-primary">{{ $item->kategori->nama_kategori }}</span>
                                    </td>
                                    <td>
                                        <span class="badge modern-badge badge-primary">{{ $item->jumlah }}</span>
                                    </td>
                                    <td>
                                        @php
                                            $kondisiColors = [
                                        ...
                                        @endphp
                                        <span class="badge modern-badge bg-{{ $kondisiColors[$item->kondisi] ?? 'secondary' }}">
                                            {{ $item->kondisi }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <br><small class="text-muted">{{ $item->lantai->nomor_lantai ? 'Lantai ' . $item->lantai->nomor_lantai . ' - ' : '' }}{{ $item->lantai->nama_lantai }} - {{ $item->gedung->nama_gedung }}</small>
                                    ...
                                    <td>
                                        ...
                                        <div class="action-buttons">
                                            <a href="{{ route('inventaris.show', $item->id) }}" class="btn btn-modern btn-info btn-sm" title="Lihat Detail">
                                            ...
                                            <a href="{{ route('inventaris.edit', $item->id) }}" class="btn btn-modern btn-warning btn-sm" title="Edit">
                                            ...
                                            <form action="{{ route('inventaris.destroy', $item->id) }}" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn btn-modern btn-danger btn-sm" 
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus inventaris ini?')" title="Hapus">
                                ...
                                <tr>
                                    <td colspan="{{ (Auth::guard('admin')->user()->role ?? '') === 'super_admin' ? '15' : '14' }}" class="text-center text-muted empty-state">
                                        <div class="empty-content">
                                            <i class="fas fa-box"></i>
                                            <p>Belum ada data inventaris. Silakan tambah data inventaris baru.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
