...
@section('title', 'Tambah Inventaris - PLN Icon Plus Kantor Management')
@section('page-title', 'Tambah Inventaris')
@section('page-subtitle', 'Tambah data inventaris baru')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control modern-input @error('tahun') is-invalid @enderror"
                                        id="tahun" name="tahun" value="{{ old('tahun') }}" min="1900" max="2030" 
            ...
            <div class="guide-card">
                ...
                <div class="guide-body">
                    ...
                    <div class="guide-section">
                        ...
                        <p class="guide-text">
                            Kalau ada foto barangnya, upload aja. Formatnya JPG atau PNG, maksimal 5MB. Ini nggak wajib sih, tapi kalau ada lebih bagus biar lebih jelas barangnya kayak apa.
                        </p>
                    </div>
                </div>
            </div>
